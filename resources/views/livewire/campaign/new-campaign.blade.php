        ...
        <div class="col-xl-8">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="card-title-desc">Set a configuration new campaign</p>
            ...
            <div class="card">
                <div class="card-body p-4">
                    <div class="search-box">
                        <p class="text-muted">From Address</p>

                        <div class="btn-group-horizontal btn-group-sm" role="group">
                            <input type="radio" class="btn-check" name="from_email" id="sales@ads.rumahaplikasi.co.id"
                                autocomplete="off" wire:click="$set('from_email', 'sales@ads.rumahaplikasi.co.id')">
                            <label class="btn btn-outline-danger"
                                for="sales@ads.rumahaplikasi.co.id">sales@ads.rumahaplikasi.co.id</label>

                            <input type="radio" class="btn-check" name="from_email" id="sales@app.rumahaplikasi.co.id"
