                                    ...
                                    <li class="list-group-item py-3">
                                        <div class="d-flex">
                                            ...
                                            <div class="align-self-center overflow-hidden me-auto">
                                                <div>
                                                    <h5 class="font-size-14 text-truncate"><a
                                                            href="javascript: void(0);" class="text-dark">Riding bike
                                                            on road</a>
                                                    </h5>
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1">
                                        ...
                                        <p class="text-muted">If several languages coalesce, the
                                            grammar of the resulting of the individual</p>
                                        <div>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table align-middle table-nowrap mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td style="width: 100px;"><img src="{{ asset('images/small/img-2.jpg') }}"
                                            alt="" class="avatar-md h-auto d-block rounded">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td><img src="{{ asset('images/small/img-6.jpg') }}" alt=""
                                ...
                                <tr>
                                    <td><img src="{{ asset('images/small/img-1.jpg') }}" alt=""
                                            class="avatar-md h-auto d-block rounded"></td>
                                    <td>
                                        <h5 class="font-size-13 text-truncate mb-1"><a href="javascript: void(0);"
                                                class="text-dark">Riding
                                                bike on road</a></h5>
                                        <p class="text-muted mb-0">24 Oct, 2020</p>
                                    </td>
                                ...
                                <tr>
                                    <td><img src="{{ asset('images/small/img-2.jpg') }}" alt=""
                                            class="avatar-md h-auto d-block rounded"></td>
                                    <td>
                                        <h5 class="font-size-13 text-truncate mb-1"><a href="javascript: void(0);"
